...
python -m pip install --quiet --upgrade pyinstaller fal-client pillow imageio-ffmpeg
...
pyinstaller --onefile --noconsole --name RenderPost --collect-all fal_client --collect-all httpx --collect-all imageio_ffmpeg %ICON% RenderPost.py
